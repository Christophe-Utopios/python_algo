...
#         # except AgeInvalideException as aie: 
#         #     print(aie)
#         except Exception as ex: #attrape tout les types d'exception non gérés par des précédents excepts
#             print(ex)
#             print(type(ex))
#         else:
#             print("Age valide !")
...
print('test')
print(p) 
# Lève une Exception "NameError: name 'p' is not defined"
# si p n'est pas définit à cause d'une Exception dans mon bloc try
